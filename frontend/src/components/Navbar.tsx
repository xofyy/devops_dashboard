...
export default function Navbar() {
  ...
  return (
    ...
    `}>
      ...
      <button
        className="flex flex-col justify-center items-center w-10 h-10 rounded focus:outline-none focus:ring-2 focus:ring-indigo-300 mr-3 md:mr-6"
      ...
      <Link to="/" className="text-2xl font-extrabold text-white tracking-wide drop-shadow select-none hover:underline focus:outline-none focus:ring-2 focus:ring-indigo-300 transition">
        DevOps Dashboard
      </Link>
      {/* Sağdaki ikonlar */}
      <div className="flex items-center gap-4 ml-auto">
        <button onClick={handleRefresh} title="Yenile" className="w-10 h-10 flex items-center justify-center rounded hover:bg-white/20 transition">
        ...
        <button
          ...
          className="w-10 h-10 flex items-center justify-center rounded hover:bg-white/20 transition relative overflow-hidden"
        >
          {/* Güneş ikonu */}
          <span
        ...
        <button onClick={handleInfo} title="Bilgi/Yardım" className="w-10 h-10 flex items-center justify-center rounded hover:bg-white/20 transition">
          <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
